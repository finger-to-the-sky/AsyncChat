...
from db.client_storage import ClientDatabase
from errors import ServerError, ReqFieldMissingError
from metaclasess import ClientVerifier
from other.variables import ACTION, TIME, USER, ACCOUNT_NAME, SENDER, PRESENCE, RESPONSE, MESSAGE, MESSAGE_TEXT, \
    ERROR, DESTINATION, EXIT, DEFAULT_IP_ADDRESS, DEFAULT_PORT, GET_CONTACTS, LIST_INFO, ADD_CONTACT, USERS_REQUEST, \
    REMOVE_CONTACT
...
def main():
    ...
    try:
        ...
        # Watchdog основной цикл, если один из потоков завершён, то значит соединение или потеряно или пользователь
